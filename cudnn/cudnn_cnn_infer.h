...
cudnnCreateConvolutionDescriptor(dpct::dnnl::convolution_desc *convDesc);

/* Destroy an instance of convolution descriptor */
dpct::err1 CUDNNWINAPI
cudnnDestroyConvolutionDescriptor(dpct::dnnl::convolution_desc convDesc);

dpct::err1 CUDNNWINAPI cudnnSetConvolutionMathType(
    dpct::dnnl::convolution_desc convDesc, cudnnMathType_t mathType);

dpct::err1 CUDNNWINAPI cudnnGetConvolutionMathType(
    dpct::dnnl::convolution_desc convDesc, cudnnMathType_t *mathType);

dpct::err1 CUDNNWINAPI cudnnSetConvolutionGroupCount(
    dpct::dnnl::convolution_desc convDesc, int groupCount);

dpct::err1 CUDNNWINAPI cudnnGetConvolutionGroupCount(
    dpct::dnnl::convolution_desc convDesc, int *groupCount);

dpct::err1 CUDNNWINAPI cudnnSetConvolutionReorderType(
    dpct::dnnl::convolution_desc convDesc, cudnnReorderType_t reorderType);

dpct::err1 CUDNNWINAPI cudnnGetConvolutionReorderType(
    dpct::dnnl::convolution_desc convDesc, cudnnReorderType_t *reorderType);

dpct::err1 CUDNNWINAPI cudnnSetConvolution2dDescriptor(
    dpct::dnnl::convolution_desc convDesc, int pad_h, /* zero-padding height */
    ...
    /*
    DPCT1082:28: Migration of cudnnConvolutionMode_t type is not supported.
    */
    cudnnConvolutionMode_t mode, dpct::library_data_t computeType);

dpct::err1 CUDNNWINAPI cudnnGetConvolution2dDescriptor(
    ...
    int *dilation_w, /* filter dilation in the horizontal dimension */
    /*
    DPCT1082:29: Migration of cudnnConvolutionMode_t type is not supported.
    */
    cudnnConvolutionMode_t *mode, dpct::library_data_t *computeType);

dpct::err1 CUDNNWINAPI cudnnSetConvolutionNdDescriptor(
    dpct::dnnl::convolution_desc convDesc, int arrayLength, /* nbDims-2 size */
    const int padA[], const int filterStrideA[], const int dilationA[],
    /*
    DPCT1082:30: Migration of cudnnConvolutionMode_t type is not supported.
    */
    cudnnConvolutionMode_t mode,
    dpct::library_data_t computeType); /* convolution data type */

/* Helper function to return the dimensions of the output tensor given a convolution descriptor */
dpct::err1 CUDNNWINAPI cudnnGetConvolutionNdDescriptor(
    const dpct::dnnl::convolution_desc convDesc, int arrayLengthRequested,
    int *arrayLength, int padA[], int strideA[], int dilationA[],
    /*
    DPCT1082:31: Migration of cudnnConvolutionMode_t type is not supported.
    */
    cudnnConvolutionMode_t *mode,
    dpct::library_data_t *computeType); /* convolution data type */

dpct::err1 CUDNNWINAPI cudnnGetConvolution2dForwardOutputDim(
    const dpct::dnnl::convolution_desc convDesc,
    const dpct::dnnl::memory_desc_ext inputTensorDesc,
    const dpct::dnnl::memory_desc_ext filterDesc, int *n, int *c, int *h,
    int *w);

/* Helper function to return the dimensions of the output tensor given a convolution descriptor */
dpct::err1 CUDNNWINAPI cudnnGetConvolutionNdForwardOutputDim(
    const dpct::dnnl::convolution_desc convDesc,
    const dpct::dnnl::memory_desc_ext inputTensorDesc,
    const dpct::dnnl::memory_desc_ext filterDesc, int nbDims,
    int tensorOuputDimA[]);

/* helper function to provide the convolution forward algo that fit best the requirement */
dpct::err1 CUDNNWINAPI cudnnGetConvolutionForwardAlgorithmMaxCount(
    dpct::dnnl::engine_ext handle, int *count);

dpct::err1 CUDNNWINAPI cudnnGetConvolutionForwardAlgorithm_v7(
    dpct::dnnl::engine_ext handle, const dpct::dnnl::memory_desc_ext srcDesc,
    const dpct::dnnl::memory_desc_ext filterDesc,
    const dpct::dnnl::convolution_desc convDesc,
    const dpct::dnnl::memory_desc_ext destDesc, const int requestedAlgoCount,
    int *returnedAlgoCount, cudnnConvolutionFwdAlgoPerf_t *perfResults);

dpct::err1 CUDNNWINAPI cudnnFindConvolutionForwardAlgorithm(
    dpct::dnnl::engine_ext handle, const dpct::dnnl::memory_desc_ext xDesc,
    const dpct::dnnl::memory_desc_ext wDesc,
    const dpct::dnnl::convolution_desc convDesc,
    const dpct::dnnl::memory_desc_ext yDesc, const int requestedAlgoCount,
    int *returnedAlgoCount, cudnnConvolutionFwdAlgoPerf_t *perfResults);

dpct::err1 CUDNNWINAPI cudnnFindConvolutionForwardAlgorithmEx(
    dpct::dnnl::engine_ext handle, const dpct::dnnl::memory_desc_ext xDesc,
    const void *x, const dpct::dnnl::memory_desc_ext wDesc, const void *w,
    const dpct::dnnl::convolution_desc convDesc,
...
dpct::err1 CUDNNWINAPI cudnnIm2Col(dpct::dnnl::engine_ext handle,
...
dpct::err1 CUDNNWINAPI cudnnReorderFilterAndBias(
    dpct::dnnl::engine_ext handle, const dpct::dnnl::memory_desc_ext filterDesc,
...
dpct::err1 CUDNNWINAPI cudnnGetConvolutionForwardWorkspaceSize(
    dpct::dnnl::engine_ext handle, const dpct::dnnl::memory_desc_ext xDesc,
    const dpct::dnnl::memory_desc_ext wDesc,
    const dpct::dnnl::convolution_desc convDesc,
    const dpct::dnnl::memory_desc_ext yDesc, dnnl::algorithm algo,
    size_t *sizeInBytes);

/* Convolution functions: All of the form "output = alpha * Op(inputs) + beta * output" */

/* Function to perform the forward pass for batch convolution */
dpct::err1 CUDNNWINAPI cudnnConvolutionForward(
...
dpct::err1 CUDNNWINAPI cudnnConvolutionBiasActivationForward(
    dpct::dnnl::engine_ext handle, const void *alpha1,
    const dpct::dnnl::memory_desc_ext xDesc, const void *x,
    const dpct::dnnl::memory_desc_ext wDesc, const void *w,
    const dpct::dnnl::convolution_desc convDesc, dnnl::algorithm algo,
    void *workSpace, size_t workSpaceSizeInBytes, const void *alpha2,
    const dpct::dnnl::memory_desc_ext zDesc, const void *z,
    const dpct::dnnl::memory_desc_ext biasDesc, const void *bias,
...
dpct::err1 CUDNNWINAPI cudnnGetConvolutionBackwardDataAlgorithmMaxCount(
    dpct::dnnl::engine_ext handle, int *count);

dpct::err1 CUDNNWINAPI cudnnFindConvolutionBackwardDataAlgorithm(
    dpct::dnnl::engine_ext handle, const dpct::dnnl::memory_desc_ext wDesc,
    const dpct::dnnl::memory_desc_ext dyDesc,
    const dpct::dnnl::convolution_desc convDesc,
    const dpct::dnnl::memory_desc_ext dxDesc, const int requestedAlgoCount,
    int *returnedAlgoCount, cudnnConvolutionBwdDataAlgoPerf_t *perfResults);

dpct::err1 CUDNNWINAPI cudnnFindConvolutionBackwardDataAlgorithmEx(
    dpct::dnnl::engine_ext handle, const dpct::dnnl::memory_desc_ext wDesc,
    const void *w, const dpct::dnnl::memory_desc_ext dyDesc, const void *dy,
    const dpct::dnnl::convolution_desc convDesc,
...
dpct::err1 CUDNNWINAPI cudnnGetConvolutionBackwardDataAlgorithm_v7(
    dpct::dnnl::engine_ext handle, const dpct::dnnl::memory_desc_ext filterDesc,
...
/* Helper function to return the minimum size of the workspace to be passed to the convolution given an algo*/
dpct::err1 CUDNNWINAPI cudnnGetConvolutionBackwardDataWorkspaceSize(
    dpct::dnnl::engine_ext handle, const dpct::dnnl::memory_desc_ext wDesc,
    const dpct::dnnl::memory_desc_ext dyDesc,
    const dpct::dnnl::convolution_desc convDesc,
    const dpct::dnnl::memory_desc_ext dxDesc, dnnl::algorithm algo,
    size_t *sizeInBytes);

dpct::err1 CUDNNWINAPI cudnnConvolutionBackwardData(
    dpct::dnnl::engine_ext handle, const void *alpha,
    const dpct::dnnl::memory_desc_ext wDesc, const void *w,
...
dpct::err1 CUDNNWINAPI cudnnGetFoldedConvBackwardDataDescriptors(
    const dpct::dnnl::engine_ext handle,
    const dpct::dnnl::memory_desc_ext filterDesc,
    const dpct::dnnl::memory_desc_ext diffDesc,
    const dpct::dnnl::convolution_desc convDesc,
    const dpct::dnnl::memory_desc_ext gradDesc,
    const dpct::dnnl::memory_format_tag transformFormat,
    dpct::dnnl::memory_desc_ext foldedFilterDesc,
    dpct::dnnl::memory_desc_ext paddedDiffDesc,
    dpct::dnnl::convolution_desc foldedConvDesc,
    dpct::dnnl::memory_desc_ext foldedGradDesc,
...
dpct::err1 CUDNNWINAPI cudnnCnnInferVersionCheck(void);
