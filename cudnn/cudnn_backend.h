...
dpct::err1 CUDNNWINAPI cudnnBackendGetAttribute(
...
dpct::err1 CUDNNWINAPI cudnnBackendExecute(
    dpct::dnnl::engine_ext handle, cudnnBackendDescriptor_t executionPlan,
